...
class Choice: UIView,UITableViewDelegate,UITableViewDataSource {
    ...
    var delegate: ChoiceDelegate? = nil
    //
    ...
    override func draw(_ rect: CGRect) {
        ...
        self.data = [Item(title: "Item 1", cell: 0, isSelected: false, isUserSelectEnable: true),
                     Item(title: "Item 2", cell: 1, isSelected: true, isUserSelectEnable: true),
                     Item(title: "Item 3", cell: 2, isSelected: false, isUserSelectEnable: true)]
        #endif
    ...
    final func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.didSelectRowAt(indexPath: indexPath, sender: tableView)
...
@objc protocol ChoiceDelegate: class {
...
class RadioCell: UITableViewCell{
    ...
    override func draw(_ rect: CGRect) {
        ...
        imgRadio.translatesAutoresizingMaskIntoConstraints = false
...
//        imgRadio.topAnchor.constraint(equalTo: topAnchor, constant: 15).isActive = true
        imgRadio.leftAnchor.constraint(equalTo: leftAnchor, constant: 10).isActive = true
        imgRadio.centerYAnchor.constraint(equalTo: centerYAnchor).isActive = true
       
        
        lblTitle.topAnchor.constraint(equalTo: topAnchor, constant: 16).isActive = true
        lblTitle.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -16).isActive = true
        lblTitle.leftAnchor.constraint(equalTo: imgRadio.rightAnchor, constant: 10).isActive = true
        lblTitle.rightAnchor.constraint(equalTo: rightAnchor, constant: -10).isActive = true
        imgRadio.heightAnchor.constraint(equalTo: lblTitle.heightAnchor, constant: -7 ).isActive = true
        imgRadio.widthAnchor.constraint(equalTo: lblTitle.heightAnchor, constant: -7 ).isActive = true
...
class InputModel: NSObject, Selectable {
    var id: Int
    var title: String
    ...
    init(id: Int, title: String, isSelected: Bool, isUserSelectEnable: Bool, age: Int) {
        self.title = title
